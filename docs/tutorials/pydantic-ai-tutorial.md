...
This tutorial shows you how to integrate LCTL (LLM Context Trace Library) v4.0 with PydanticAI for time-travel debugging and observability of agent runs, tool calls, and structured outputs.
