...
class TracerMixin:
    """Mixin providing standard tracer methods for callback-style integrations.

    Use this when the integration uses callbacks rather than wrapping.
    """
    _session: LCTLSession
